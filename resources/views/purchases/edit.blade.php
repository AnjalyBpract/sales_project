...
<div class="container mt-2">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Quantity</strong>
                <input type="text" name="quantity" value="{{ $purchase->quantity }}" class="form-control" id="quantity_id">
            @error('quantity')
                <div class="mt-1 mb-1 alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Rate</strong>
                <input type="text" name="rate" value="{{ $purchase->rate }}" class="form-control" id="rate_id">
            @error('rate')
                <div class="mt-1 mb-1 alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Total Amount</strong>
                <input type="text" name="total_amount" value="{{ $purchase->total_amount }}" class="form-control" id ="total_amount" >
            @error('total_amount')
                <div class="mt-1 mb-1 alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
