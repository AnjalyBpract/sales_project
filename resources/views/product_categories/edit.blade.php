...
<div class="container mt-2">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <a class="btn btn-primary" href="{{ route('product_categories.index') }}" enctype="multipart/form-data"> Back</a>
            </div>
        </div>
    </div>
        @if(session('status'))
        ...
        @endif
    <form action="{{ route('product_categories.update',$product_category->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Name:</strong>
                <input type="text" name="name" value="{{ $product_category->name }}" class="form-control" placeholder="Company name">
            @error('name')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <textarea class="form-control" name="description"  id="exampleFormControlTextarea1" rows="4">{{ $product_category->description }}</textarea>
